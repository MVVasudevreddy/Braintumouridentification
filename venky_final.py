...
no_tumor_samples = glob.glob("/content/drive/MyDrive/MB/test/images/*no*tumor*") + \
...
tumor_samples = glob.glob("/content/drive/MyDrive/MB/test/images/*tumor*") + \
...
detected_imgs = glob.glob("/content/yolov7/runs/detect/exp/*.jpg") + \
                glob.glob("/content/yolov7/runs/detect/exp/*.png")
if detected_imgs:
    for img_path in detected_imgs[:6]:   # Show max 6 results
...
# ============================================================
# STEP 20 : Save Model Summary / Export (Optional ONNX)
# ============================================================
...
print("ONNX export complete (if supported). Check runs/train/exp/weights/")

# ============================================================
# END OF PROJECT
# ============================================================
print("\nProject complete! Brain Tumor Identification using YOLOv7 - by Vasudev")
